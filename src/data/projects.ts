...
export const projects: Project[] = [
  {
    ...
    links: {
      ...
      appStore: 'https://apps.apple.com/app/klog-academy',
      playStore: 'https://play.google.com/store/apps/details?id=com.klogacademy'
    },
    emoji: '🚀',
    featured: true
  },
  {
    ...
    links: {
      ...
      playStore: 'https://play.google.com/store/apps/details?id=com.graoapp&hl=pt_BR'
    },
    emoji: '💰',
    featured: true
  },
  {
    ...
    links: {
      ...
      playStore: 'https://play.google.com/store/apps/details?id=com.mindless.mindlessapp'
    },
    emoji: '🧘',
    featured: true
  },
  {
    ...
    links: {
      ...
      playStore: 'https://play.google.com/store/apps/details?id=com.matchday_app&hl=pt_BR'
    },
    emoji: '⚽',
    featured: false
  },
  {
    ...
    tech: ['Next.js', 'TypeScript', 'WebContainers', 'CodeMirror 6', 'Tailwind CSS'],
    status: 'live',
    links: {
  ...
  },
  {
    ...
    tech: ['Next.js', 'TypeScript', 'Babel Standalone', 'CodeMirror 6', 'Tailwind CSS'],
    status: 'live',
    links: {
